...
public class DicomFileUtils {
    ...
    private static final Logger logger = LoggerFactory.getLogger(DicomFileUtils.class);
        ...
        try {
            ...
            // @formatter:off
                if (length >= 136 && new String(b, 128, 4).equals("DICM") && extractUnsigned16(b, 132, false) == 0x0002) {
                    ...
                    return true;
                } else if (length >= 136 && new String(b, 128, 4).equals("DICM") && extractUnsigned16(b, 132, true) == 0x0002) {
                    // big endian header
                    return true;
                        ...
                        && (extractUnsigned32(b, 4, false) <= 0x0100/* valid VL */
                            || (Character.isUpperCase((char) (b[4])) && Character.isUpperCase((char) (b[5]))) /* Upper case VR/ */)) {
                    return true;
